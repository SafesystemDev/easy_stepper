      ...
      child: Column(
        children: [
          Material(
            ...
            borderRadius: stepShape != StepShape.circle ? BorderRadius.circular(stepRadius ?? 0) : null,
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  shape: stepShape == StepShape.circle ? BoxShape.circle : BoxShape.rectangle,
                  borderRadius: stepShape != StepShape.circle ? BorderRadius.circular(stepRadius ?? 0) : null,
                  color: isFinished
                      ? finishedBackgroundColor ?? Theme.of(context).colorScheme.primary
                      : isActive
                ...
                child: EasyBorder(
                  borderType: stepShape == StepShape.circle ? BorderType.Circle : BorderType.RRect,
                  strokeCap: StrokeCap.round,
                  radius: stepShape != StepShape.circle ? Radius.circular(stepRadius ?? 0) : const Radius.circular(0),
                  color: isActive
                  ...
                  child: isActive && step.activeIcon == null
                      ? Center(
                          child: Lottie.asset(
                            lottieAnimation ??
                                (((activeStepBackgroundColor != null && activeStepBackgroundColor!.computeLuminance() < 0.35) && activeStepBackgroundColor != Colors.transparent)
                ...
                child: Text(
                  ...
                  style: Theme.of(context).textTheme.bodyText2!.copyWith(
                        color: isActive
                            ...
                            : isFinished
                                ? finishedTextColor ?? Theme.of(context).colorScheme.primary
