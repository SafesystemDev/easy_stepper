...
class EasyStepper extends StatefulWidget {
  ...
  const EasyStepper({
    ...
    this.lineSpace = 5,
    this.padding = 8,
    @Deprecated("use 'stepAnimationCurve' instead, This feature was deprecated after v0.1.4+1") this.stepReachedAnimationEffect = Curves.linear,
    this.stepAnimationCurve,
    @Deprecated("use 'stepAnimationDuration' instead, This feature was deprecated after v0.1.4+1") this.stepReachedAnimationDuration = const Duration(seconds: 1),
  ...
  void _afterLayout(_) {
    ...
    for (int i = 0; i < widget.steps.length; i++) {
      _scrollController!.animateTo(
        i * ((widget.stepRadius * 1 + (widget.padding / 2)) + widget.lineLength),
        duration: widget.stepAnimationDuration ?? widget.stepReachedAnimationDuration,
      ...
      child: Align(
        ...
        child: NotificationListener<OverscrollIndicatorNotification>(
          ...
          child: SingleChildScrollView(
            ...
            physics: widget.disableScroll ? const NeverScrollableScrollPhysics() : const ClampingScrollPhysics(),
            ...
            children: [
              Padding(
                padding: EdgeInsets.only(
                  top: axis == Axis.horizontal ? (widget.stepRadius - widget.lineDotRadius) : 0,
              ...
              if (axis == Axis.horizontal && widget.steps[index].lineText != null) ...[
